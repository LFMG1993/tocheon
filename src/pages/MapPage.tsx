    ...
    return (
        <div className="relative w-full h-full min-h-[400px] max-w-md mx-auto">
            ...
            <div className="absolute inset-0 flex items-start justify-end p-4 z-10 pointer-events-none">
                <div
                    className="max-w-xs text-center bg-card/90 backdrop-blur-sm p-4 rounded-2xl shadow-lg border border-border pointer-events-auto">
                    <div className="flex justify-center items-center mb-2">
                        <Route className="h-8 w-8 text-primary" strokeWidth={1.5}/>
                        <HeartPulse className="h-5 w-5 text-rose-500 -ml-3 mt-4" strokeWidth={2.5}/>
                    </div>
                    ...
                    <p className="text-muted-foreground mt-2 text-xs max-w-sm mx-auto">
